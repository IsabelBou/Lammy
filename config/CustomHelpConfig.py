    ...
    ask=dict(
        ...
        fields=[
            dict(
                ...
                value="Sends a message with the nightmare information and three emojis for members to react to: *emojis here*. Each member should select either *S or L* to indicate said nightmare's availability and evolution level, as well as *check* to indicate the nightmare is being equipped, in case it needs to be summoned and the assigned summoner is afk for colosseum."
            )
        ]
    ),
    check=dict(
